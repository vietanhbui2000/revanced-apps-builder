...
--keystore-entry-password=1234567890 --keystore-password=1234567890 --signer=vietanhbui2000 --keystore-entry-alias=vietanhbui2000 $patcher_args"
...
build_rv() {
	...
	for build_mode in "${build_mode_arr[@]}"; do
		...
		if [ "$build_mode" = apk ]; then
			local apk_output="${BUILD_DIR}/${app_name_l}_v${version_f}-${arch_f}_${rv_brand_f}.apk"
