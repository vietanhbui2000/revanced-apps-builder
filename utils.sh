...
--keystore-entry-password=1234567890 --keystore-password=1234567890 --signer=vietanhbui2000 --keystore-entry-alias=vietanhbui2000 -t '$patched_apk-tmp' $patcher_args"
